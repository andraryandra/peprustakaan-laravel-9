...
class AnggotaEbookItemController extends Controller
{
    /**
    ...
    public function index(Ebook $ebook)
    {
        ...
        return view("user.anggota.artikel.ebook.cerita.index", compact("buku", "subkategori", "kategori", "user",'users', 'ebookItem'));
    }
    ...
    public function isiCeritaAnggota($id)
    {
        ...
        return view("user.anggota.artikel.ebook.cerita.create", compact("buku", "user",'users', "subkategori", "kategori"));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (count($bookItems) > 0) {
            return redirect()->route('anggota-ebook-isi.show', $bookItems[0]->ebook_id)->with('berhasil', 'Buku baru telah ditambahkan');
        } else {
    ...
    public function show($id)
        {
            ...
            return view("user.anggota.artikel.ebook.cerita.index", compact("buku", "user",'users', "subkategori", "kategori", "isi_buku"));
        }
    ...
    public function edit($id)
    {
        ...
        return view("user.anggota.artikel.ebook.cerita.edit", compact("isi_buku"));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    if ($ebookItem) {
        ...
        return redirect()->route('anggota-ebook-isi.show', $ebookItem->ebook_id)->with('berhasil', 'Buku telah diperbarui');
    } else {
    ...
    public function destroy($id)
    {
        ...
        if ($deleted) {
            return redirect()->route('anggota-ebook-isi.index.show', $ebookId)->with('berhasil', 'Buku telah dihapus');
        } else {
