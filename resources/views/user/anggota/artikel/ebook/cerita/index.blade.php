...
@section('ebook')
    ...
    <div class="page-content">
        <div class="my-3">
            <button type="button" onclick="window.location.href='{{ route('anggota-ebook.index') }}'"
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <button type="button" class="btn btn-primary me-2"
                                                        onclick="window.location.href='{{ route('anggota-ebook-isi.edit', $item->id) }}'">
                                                        <i class="bi bi-pencil-square"></i> Edit
                                                    </button>
                                                    <form action="{{ route('anggota-ebook-isi.destroy', $item->id) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
    ...
    {{-- <div class="modal fade" id="exampleModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 50%">
            <div class="modal-content">
                ...
                <form action="{{ route('anggota-ebook-isi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
