            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            <form action="{{ route('buku-isi.update', $isi_buku->id) }}" method="POST"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="judul_part"
                                                    ...
                                                    placeholder="Tambahkan judul part" value="{{ $isi_buku->judul_part }}">
                                            </div>
                                        </div><!-- Col -->
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content_part" id="content_part" class="form-control" rows="5"
                                                    placeholder="Tambahkan Content Ebook" value="{{ $isi_buku->content_part }}">{{ $isi_buku->content_part }}</textarea>
                                            </div>
                                        </div><!-- Col -->
                                    </div>
                                </div>
