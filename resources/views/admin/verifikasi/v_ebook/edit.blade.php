@foreach ($data_ebook as $item)
    ...
    <div class="modal fade" id="exampleModalToggle2{{ $item->id }}" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title " id="exampleModalToggleLabel2{{ $item->id }}">Verifikasi Ebook</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        @foreach ($item->ebook_item_verify as $item2)
                            <form action="{{ route('verifikasiEbook.update', $item2->id) }}" method="POST"
                                ...
                                <div class="mb-3" hidden>
                                    <input type="text" class="form-control" id="verifikasi_ebook"
                                        name="verifikasi_ebook" value="ACTIVE" readonly>
                                </div>
                    ...
                    <div class="row mt-3">
                        @foreach ($item->ebook_item_verify as $item2)
                            <form action="{{ route('verifikasiEbook.update', $item2->id) }}" method="POST"
                                ...
                                <div class="mb-3" hidden>
                                    <input type="text" class="form-control" id="verifikasi_ebook"
                                        name="verifikasi_ebook" value="INACTIVE" readonly>
                                </div>
